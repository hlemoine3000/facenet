...
def _make_matches(image_dir: str,
    ...
    while curr_matches < total_matches:
        ...
        if len(images) > 1:
            img1 = 0
            img2 = re.search(r'_...._(.*?).png', random.choice(images)).group(1)
    ...
    while curr_matches < total_matches:
        ...
        if person1 != person2:
            ...
            if person1_images and person2_images:
                img1 = 0
                img2 = re.search(r'_...._(.*?).png', random.choice(person2_images)).group(1)
...
# --still_image_dir /export/livia/data/lemoineh/COX-S2V/COX-S2V-Still-MTCNN160 \
# --video_images_dir_dir /export/livia/data/lemoineh/COX-S2V/COX-S2V-Video/video2_182 \
# --pairs_file_name cox_pair \
# --num_folds 10 \
# --num_matches_mismatches 50
